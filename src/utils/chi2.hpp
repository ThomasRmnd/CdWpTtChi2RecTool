...
inline double chi2_fht_method(RecPmtTable::const_iterator first, RecPmtTable::const_iterator last, std::vector<double>::const_iterator theo) {
...
inline double chi2_tt_method(std::vector<vec3>::const_iterator first, std::vector<vec3>::const_iterator last, std::vector<vec3>::const_iterator theo) {
