...
template<typename _Tp>
inline constexpr _Tp tan_cherenkov_ls_v = std::sqrt(n_ls_v<_Tp> * n_ls_v<_Tp> - static_cast<_Tp>(1.0)); // tangent of the cherenkov angle in the LS (1)

inline constexpr double tan_cherenkov_ls = tan_cherenkov_ls_v<double>;

template<typename _Tp>
inline constexpr _Tp tan_cherenkov_w_v = std::sqrt(n_w_v<_Tp> * n_w_v<_Tp> - static_cast<_Tp>(1.0)); // tangent of the cherenkov angle in the water (1)

inline constexpr double tan_cherenkov_w = tan_cherenkov_w_v<double>;

template<typename _Tp>
inline constexpr _Tp inv_tan_cherenkov_ls_v = static_cast<_Tp>(1.0) / tan_cherenkov_ls_v<_Tp>; // inverse of the tangent of the cherenkov angle in the LS (1)

inline constexpr double inv_tan_cherenkov_ls = inv_tan_cherenkov_ls_v<double>;

template<typename _Tp>
inline constexpr _Tp inv_tan_cherenkov_w_v = static_cast<_Tp>(1.0) / tan_cherenkov_w_v<_Tp>; // inverse of the tangent of the cherenkov angle in the water (1)

inline constexpr double inv_tan_cherenkov_w = inv_tan_cherenkov_w_v<double>;

template<typename _Tp>
inline constexpr _Tp inv_c_tan_cherenkov_ls_v = inv_c_v<_Tp> * inv_tan_cherenkov_ls_v<_Tp>; // inverse of the tangent of the cherenkov angle in the LS multiplied by the speed of light (ns/mm)

inline constexpr double inv_c_tan_cherenkov_ls = inv_c_tan_cherenkov_ls_v<double>;

template<typename _Tp>
inline constexpr _Tp inv_c_tan_cherenkov_w_v = inv_c_v<_Tp> * inv_tan_cherenkov_w_v<_Tp>; // inverse of the tangent of the cherenkov angle in the water multiplied by the speed of light (ns/mm)

inline constexpr double inv_c_tan_cherenkov_w = inv_c_tan_cherenkov_w_v<double>;
