...
public:
    ...
    CorrectionMap(const std::string& name, const PmtType& pmt_type, const std::shared_ptr<CorrectionFile>& file, const std::string& filename, const std::string& mapname) :
        ToolBase(name),
